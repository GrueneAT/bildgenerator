/*! Grüne Bildgenerator v1.0.0 | Built: 2026-08-19T12:36:35.781Z */
var GrueneApp=(()=>{var __defProp=Object.defineProperty,__defProps=Object.defineProperties;var __getOwnPropDescs=Object.getOwnPropertyDescriptors;var __getOwnPropSymbols=Object.getOwnPropertySymbols;var __hasOwnProp=Object.prototype.hasOwnProperty,__propIsEnum=Object.prototype.propertyIsEnumerable;var __defNormalProp=(obj,key,value)=>key in obj?__defProp(obj,key,{enumerable:!0,configurable:!0,writable:!0,value}):obj[key]=value,__spreadValues=(a,b)=>{for(var prop in b||(b={}))__hasOwnProp.call(b,prop)&&__defNormalProp(a,prop,b[prop]);if(__getOwnPropSymbols)for(var prop of __getOwnPropSymbols(b))__propIsEnum.call(b,prop)&&__defNormalProp(a,prop,b[prop]);return a},__spreadProps=(a,b)=>__defProps(a,__getOwnPropDescs(b)),__name=(target,value)=>__defProp(target,"name",{value,configurable:!0});const AppConstants={FILE:{FILENAME_LENGTH:6,MAX_SIZE_MB:10,VALID_IMAGE_TYPES:["image/jpeg","image/png","image/webp","image/svg+xml"]},UI:{ALERT_DURATION:3e3,ALERT_FADE_SPEED:300,MAX_ALERTS:3,WIZARD_TOTAL_STEPS:4},CANVAS:{SCALE_MAX_MULTIPLIER:.002,SNAP_ZONE_RATIO:20,TARGET_FIND_TOLERANCE:15,CORNER_SIZE_MULTIPLIER:.03,BORDER_SCALE_FACTOR:2,PADDING:4,ROTATION_SNAP_TOLERANCE:2,ROTATION_SNAP_ANGLES:[0,90,180,270]},EXPORT:{DEFAULT_DPI:200,SCREEN_DPI:72,MAX_PIXELS:25e7,QR_MIN_SIZE:512,QR_MAX_SIZE:2048,QR_BORDER_PERCENT:.05},SCALING:{TEXT_DEFAULT_WIDTH_RATIO:.8,TEXT_DEFAULT_HEIGHT_RATIO:.5,IMAGE_DEFAULT_WIDTH_RATIO:.5,IMAGE_DEFAULT_HEIGHT_RATIO:.4,QR_DEFAULT_WIDTH_RATIO:.25,QR_DEFAULT_HEIGHT_RATIO:.25,CIRCLE_DEFAULT_WIDTH_RATIO:.3,CIRCLE_DEFAULT_HEIGHT_RATIO:.3,CROSS_DEFAULT_WIDTH_RATIO:.4,CROSS_DEFAULT_HEIGHT_RATIO:.3},CIRCLE_SIZES:{LARGE:{value:2,percentage:.9},MEDIUM:{value:3,percentage:.7},SMALL:{value:4,percentage:.5}},COLORS:{BACKGROUND_PRIMARY:"#257639",BACKGROUND_SECONDARY:"#257639",PINK_CIRCLE:"#E6007E",LOGO_TEXT:"#257639",LOGO_KNOCKOUT:"#ffffff",TEXT_STROKE:"#000000",CORNER_COLOR:"yellow",BORDER_COLOR:"rgba(88,42,114)",CORNER_STROKE:"#000000"},FONTS:{FAMILY:"Gotham Narrow",DEFAULT_LOGO:"Gotham Narrow",DEFAULT_TEXT:"Gotham Narrow",WEIGHT_TEXT:900,WEIGHT_LOGO:700,WEIGHT_BOOK:400,CHAR_SPACING:0,OPTIONS:[{id:"standard",label:"Standardschrift \u2014 Headlines & Flie\xDFtext",family:"Gotham Narrow",weight:900,style:"normal"},{id:"accent",label:"Betonte Serifenschrift \u2014 f\xFCr Zitate & Akzente",family:"Vollkorn",weight:900,style:"italic"}],PRELOAD_FONTS:[{family:"Gotham Narrow",weight:900,style:"italic"},{family:"Gotham Narrow",weight:900},{family:"Gotham Narrow",weight:400},{family:"Gotham Narrow",weight:700},{family:"Vollkorn",weight:900,style:"italic"},{family:"Vollkorn",weight:400}]},LOGO:{TEXT_SCALE_LONG:4.8,TEXT_SCALE_SHORT:6,MAX_TEXT_LENGTH:16,LINE_HEIGHT:.8,ANGLE:-5,WIDTH_SCALE:.95,BAR_OFFSET_FROM_TOP:.9,BAR_OFFSET_FROM_TOP_LONG:.89,BORDERLESS_MARGIN_PERCENT:.02,FILES:{LONG:"Logo-zweizeilig_blanko.png",SHORT:"Logo-einzeilig_blanko.png"}}},TemplateConstants={TEMPLATES:{feed_post_45:{width:1080,height:1350,topBorderMultiplier:1,border:0,dpi:200,logoWidth:163},story:{width:1080,height:1920,topBorderMultiplier:1,border:0,dpi:200,logoWidth:163},event:{width:1920,height:1005,topBorderMultiplier:1,border:0,dpi:200,logoWidth:163},facebook_header:{width:820,height:360,topBorderMultiplier:1,border:0,dpi:150,logoWidth:163},a4:{width:2480,height:3508,topBorderMultiplier:1,border:0,dpi:250,logoWidth:374},a4_quer:{width:3508,height:2480,topBorderMultiplier:1,border:0,dpi:250,logoWidth:374},a5:{width:1748,height:2480,topBorderMultiplier:1,border:0,dpi:300,logoWidth:319},a5_quer:{width:2480,height:1748,topBorderMultiplier:1,border:0,dpi:300,logoWidth:319},a6:{width:1240,height:1748,topBorderMultiplier:1,border:0,dpi:300,logoWidth:224},a6_quer:{width:1748,height:1240,topBorderMultiplier:1,border:0,dpi:300,logoWidth:224}},getTemplate(templateName){return this.TEMPLATES[templateName]||null},getCurrentTemplate(){const templateName=jQuery("#canvas-template").find(":selected").attr("value");return this.getTemplate(templateName)}},template_values=TemplateConstants.TEMPLATES;function currentTemplate(){return TemplateConstants.getCurrentTemplate()}__name(currentTemplate,"currentTemplate");window.AppConstants=AppConstants;window.TemplateConstants=TemplateConstants;window.template_values=template_values;window.currentTemplate=currentTemplate;const ValidationUtils={VALID_IMAGE_TYPES:["image/jpeg","image/png","image/webp","image/svg+xml"],isValidImage(fileType){return this.VALID_IMAGE_TYPES.includes(fileType)},isValidImageFile(file){return file?this.isValidImage(file.type):!1},isValidJSON(str){try{return JSON.parse(str),!0}catch(e){return!1}},validateStep1(){const template2=jQuery("#canvas-template").val(),logo2=jQuery("#logo-selection").val(),logoEnabled=LogoState.isLogoEnabled(),errors=[];return template2||errors.push("Bitte w\xE4hlen Sie eine Vorlage aus."),logoEnabled&&!logo2&&errors.push("Bitte w\xE4hlen Sie ein Logo aus."),{isValid:errors.length===0,errors}},validateTextInput(text){return!text||text.trim()===""?{isValid:!1,error:"Text field is empty"}:{isValid:!0,error:null}},validateQRInput(text){return!text||text.trim()===""?{isValid:!1,error:"QR Code Text field is empty"}:typeof QRCode=="undefined"?{isValid:!1,error:"QR Code library not loaded"}:{isValid:!0,error:null}},validateCanvasObject(object,allowedTypes=[]){return object?allowedTypes.length>0&&!allowedTypes.includes(object.type)?{isValid:!1,error:`Invalid object type. Expected: ${allowedTypes.join(", ")}, got: ${object.type}`}:{isValid:!0,error:null}:{isValid:!1,error:"No object selected"}},validateCircleClipTarget(activeObject){return activeObject?activeObject===contentImage?{isValid:!1,error:'Kreis-Ausschnitt kann nicht auf das Hintergrundbild angewendet werden. F\xFCgen Sie zuerst ein eigenes Bild \xFCber "Bild hinzuf\xFCgen" ein.',type:"warning"}:activeObject===logo||activeObject===logoName?{isValid:!1,error:"Kreis-Ausschnitt kann nicht auf das Logo angewendet werden. W\xE4hlen Sie ein eingef\xFCgtes Bild aus.",type:"warning"}:activeObject.type==="image"||activeObject.type==="rect"||activeObject.type==="circle"?{isValid:!0,error:null}:{isValid:!1,error:"Kreis-Ausschnitt kann nur auf eingef\xFCgte Bilder und Elemente angewendet werden. W\xE4hlen Sie zuerst ein Element aus.",type:"warning"}:{isValid:!1,error:"Bitte w\xE4hlen Sie zuerst ein Element aus, um einen Kreis-Ausschnitt anzuwenden.",type:"warning"}},validateDownload(){return LogoState.isLogoEnabled()&&(!logoText||logoText==="")?{isValid:!1,error:"W\xE4hle bitte ein Logo aus vor dem Download!"}:{isValid:!0,error:null}},validateFileSize(file,maxSizeMB=10){if(!file)return{isValid:!1,error:"No file provided"};const maxSizeBytes=maxSizeMB*1024*1024;return file.size>maxSizeBytes?{isValid:!1,error:`File too large. Maximum size is ${maxSizeMB}MB`}:{isValid:!0,error:null}}};window.ValidationUtils=ValidationUtils;const LogoState={_enabled:!0,isLogoEnabled(){return this._enabled},setLogoEnabled(enabled){this._enabled=!!enabled},initialize(){this._enabled=!0}};typeof window!="undefined"&&(window.LogoState=LogoState);typeof global!="undefined"&&(global.LogoState=LogoState);const AlertSystem={config:{duration:5e3,fadeSpeed:300,maxAlerts:3},alertTypes:{success:{toast:"gat-toast--success",callout:"gat-callout--success",icon:"fas fa-check-circle"},warning:{toast:"gat-toast--warn",callout:"gat-callout--warn",icon:"fas fa-exclamation-triangle"},warn:{toast:"gat-toast--warn",callout:"gat-callout--warn",icon:"fas fa-exclamation-triangle"},danger:{toast:"gat-toast--error",callout:"gat-callout--error",icon:"fas fa-exclamation-circle"},error:{toast:"gat-toast--error",callout:"gat-callout--error",icon:"fas fa-exclamation-circle"},info:{toast:"gat-toast--info",callout:"gat-callout--info",icon:"fas fa-info-circle"}},getContainer(){let container=jQuery(".gat-toaster").first();if(container.length===0){const legacy=jQuery(".app-alert-container").first();legacy.length?(legacy.addClass("gat-toaster").removeClass("hidden"),container=legacy):(container=jQuery('<div class="gat-toaster app-alert-container" role="region" aria-live="polite" aria-label="Benachrichtigungen"></div>'),jQuery("body").append(container))}return container},show(message,type="info",options={}){const container=options.container?jQuery(options.container):this.getContainer();return this.showInContainer(message,type,container,options)},showInContainer(message,type="info",container,options={}){const alertConfig=this.alertTypes[type]||this.alertTypes.info;if(container.length===0)return null;const isToastRegion=container.hasClass("gat-toaster")||container.hasClass("app-alert-container");if(options.clearExisting)container.empty();else{const existingAlerts=container.find(".alert");existingAlerts.length>=this.config.maxAlerts&&existingAlerts.first().remove()}const alertHTML=isToastRegion?`
                <div class="gat-toast ${alertConfig.toast} alert" role="alert">
                    ...
                    <button type="button" class="gat-toast__close alert-close-btn" aria-label="Schlie\xDFen">
        ...
        `;this.customSelect=jQuery(customSelect),this.element.after(this.customSelect),this.button=this.customSelect.find(".app-searchable-select-button"),this.dropdown=this.customSelect.find(".app-searchable-select-dropdown"),this.searchInput=this.customSelect.find(".app-searchable-select-search"),this.optionsContainer=this.customSelect.find(".app-searchable-select-options"),this.textElement=this.customSelect.find(".app-searchable-select-text")}renderOptions(searchTerm=""){let html="";return this.originalOptions.forEach(item=>{if(item.type==="group"){const groupOptions=item.options.filter(opt=>{const searchLower=searchTerm.toLowerCase(),textMatch=opt.text.toLowerCase().includes(searchLower),valueMatch=opt.value.toLowerCase().includes(searchLower),valueSpaceMatch=opt.value.replace(/%/g," ").toLowerCase().includes(searchLower);return textMatch||valueMatch||valueSpaceMatch});groupOptions.length>0&&(html+=`<div class="app-searchable-select-option-group">${item.label}</div>`,groupOptions.forEach(option=>{const selectedClass=option.value===this.selectedValue?"selected":"";html+=`<div class="app-searchable-select-option ${selectedClass}" data-value="${option.value}">${option.text}</div>`}))}else if(item.type==="option"){const searchLower=searchTerm.toLowerCase(),textMatch=item.text.toLowerCase().includes(searchLower),valueMatch=item.value.toLowerCase().includes(searchLower),valueSpaceMatch=item.value.replace(/%/g," ").toLowerCase().includes(searchLower);if(textMatch||valueMatch||valueSpaceMatch){const selectedClass=item.value===this.selectedValue?"selected":"";html+=`<div class="app-searchable-select-option ${selectedClass}" data-value="${item.value}">${item.text}</div>`}}}),html===""&&searchTerm!==""&&(html=`<div class="px-3 py-2 text-gray-500 text-sm">${this.options.noResultsText}</div>`),html}bindEvents(){this.button.on("click",e=>{e.preventDefault(),this.toggle()}),jQuery(document).on("click",e=>{!this.customSelect.is(e.target)&&this.customSelect.has(e.target).length===0&&this.close()}),this.searchInput.on("input",e=>{const searchTerm=e.target.value;this.optionsContainer.html(this.renderOptions(searchTerm)),this.bindOptionEvents()}),this.searchInput.on("keydown",e=>{e.key==="Escape"&&this.close()}),this.bindOptionEvents()}bindOptionEvents(){this.optionsContainer.find(".app-searchable-select-option").off("click").on("click",e=>{const value=jQuery(e.target).data("value"),text=jQuery(e.target).text();this.selectOption(value,text),this.close()})}selectOption(value,text=null){if(this.selectedValue=value,text===null){const findOption=__name(items=>{for(let item of items)if(item.type==="group"){const found=findOption(item.options);if(found)return found}else if(item.value===value)return item;return null},"findOption"),option=findOption(this.originalOptions);text=option?option.text:value}this.selectedText=text,this.textElement.text(text||this.options.placeholder),this.element.val(value),this.element.trigger("change"),this.updateOptionStates()}updateOptionStates(){this.optionsContainer.find(".app-searchable-select-option").removeClass("selected"),this.optionsContainer.find(`[data-value="${this.selectedValue}"]`).addClass("selected")}toggle(){this.isOpen?this.close():this.open()}open(){this.dropdown.removeClass("hidden"),this.button.attr("aria-expanded","true"),this.customSelect.find(".app-searchable-select-chevron svg").addClass("rotate-180"),this.isOpen=!0,setTimeout(()=>{this.searchInput.focus()},10),this.searchInput.val(""),this.optionsContainer.html(this.renderOptions()),this.bindOptionEvents()}close(){this.dropdown.addClass("hidden"),this.button.attr("aria-expanded","false"),this.customSelect.find(".app-searchable-select-chevron svg").removeClass("rotate-180"),this.isOpen=!1}refresh(){this.storeOriginalOptions(),this.optionsContainer.html(this.renderOptions()),this.bindOptionEvents()}addOption(value,text,groupLabel=null){const option=jQuery(`<option value="${value}">${text}</option>`);if(groupLabel){let optgroup=this.element.find(`optgroup[label="${groupLabel}"]`);optgroup.length===0&&(optgroup=jQuery(`<optgroup label="${groupLabel}"></optgroup>`),this.element.append(optgroup)),optgroup.append(option)}else this.element.append(option);this.refresh()}clearOptions(){this.element.empty().append('<option value="">Select an option...</option>'),this.selectedValue="",this.selectedText="",this.textElement.text(this.options.placeholder),this.refresh()}};__name(_SearchableSelect,"SearchableSelect");let SearchableSelect=_SearchableSelect;jQuery.fn.searchableSelect=function(options){return this.each(function(){jQuery(this).data("searchable-select")||jQuery(this).data("searchable-select",new SearchableSelect(this,options))})};jQuery(function(){jQuery("#logo-selection").searchableSelect({placeholder:"Logo Ausw\xE4hlen",searchPlaceholder:"Logo suchen...",noResultsText:"Keine Logos gefunden"})});jQuery(function(){function waitForFabric(){typeof fabric!="undefined"?typeof initializeApplication=="function"&&initializeApplication():setTimeout(waitForFabric,50)}__name(waitForFabric,"waitForFabric"),waitForFabric()});function setValue(key,value){const activeObject=canvas.getActiveObject();activeObject&&(activeObject.set(key,value),canvas.renderAll())}__name(setValue,"setValue");function createShadow(color,width){return`${color} 2px 2px ${width}`}__name(createShadow,"createShadow");function toggleTextMethods(enable){const $textMethods=jQuery(".text-method"),$alignButtons=jQuery(".align");enable?($textMethods.attr("disabled",!1),$alignButtons.removeClass("disabled")):($textMethods.attr("disabled","disabled"),$alignButtons.addClass("disabled"))}__name(toggleTextMethods,"toggleTextMethods");function enableTextMethods(){toggleTextMethods(!0)}__name(enableTextMethods,"enableTextMethods");function createImgName(){const chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let result="";for(let i=0;i<AppConstants.FILE.FILENAME_LENGTH;i++)result+=chars.charAt(Math.floor(Math.random()*chars.length));const format=jQuery("#image-format").find(":selected").attr("value");return`${result}.${format}`}__name(createImgName,"createImgName");jQuery(function(){jQuery(".app-memes-container").delegate("img","click",function(){var $img=jQuery(this),imgInfo={url:$img.attr("src"),height:$img.attr("img-height"),width:$img.attr("img-width")};processMeme(imgInfo)});function loadMemeFile(file){if(!file)return;if(!ValidationUtils.isValidImageFile(file)){showAlert("Error! Invalid Image");return}const reader=new FileReader;reader.onload=function(){var meme=new Image;meme.onload=function(){processMeme({url:reader.result,height:meme.height,width:meme.width})},meme.onerror=function(){showAlert("Error loading image")},meme.src=reader.result},reader.onerror=function(){showAlert("Error reading file")},reader.readAsDataURL(file)}__name(loadMemeFile,"loadMemeFile"),jQuery("#meme-input").on("change",function(){const file=this.files[0];jQuery("#meme-input").val(""),loadMemeFile(file)});const dropzone=document.getElementById("meme-dropzone");dropzone&&(["dragenter","dragover"].forEach(function(evt){dropzone.addEventListener(evt,function(e){e.preventDefault(),e.stopPropagation(),dropzone.classList.add("is-dragover")})}),["dragleave","dragend","drop"].forEach(function(evt){dropzone.addEventListener(evt,function(e){e.preventDefault(),e.stopPropagation(),dropzone.classList.remove("is-dragover")})}),dropzone.addEventListener("drop",function(e){const file=e.dataTransfer&&e.dataTransfer.files&&e.dataTransfer.files[0];loadMemeFile(file)}))});function loadFont(font){const customFonts=["Gotham Narrow","Vollkorn"],text=canvas.getActiveObject();text&&(customFonts.includes(font)?new FontFaceObserver(font).load().then(function(){text.set("fontFamily",""),text.set("fontFamily",font),canvas.renderAll()}):(text.set("fontFamily",font),canvas.renderAll()))}__name(loadFont,"loadFont");function updateInputs(){const activeObject=canvas.getActiveObject();activeObject&&activeObject.get("type")==="text"&&(enableTextMethods(),jQuery("#text").val(activeObject.text),jQuery("#text-color").val(activeObject.fill),jQuery("#line-height").val(activeObject.lineHeight),jQuery(`input[value="${activeObject.textAlign}"]`).parent().trigger("update-status"),updateScale(activeObject))}__name(updateInputs,"updateInputs");function updateScale(activeObject){const scale=Number(parseFloat(activeObject.scaleX)).toFixed(2);jQuery("#scale").val(scale)}__name(updateScale,"updateScale");function toggleSection(sectionId){const section=document.getElementById(sectionId),chevron=document.getElementById(sectionId+"-chevron"),button=document.querySelector(`[onclick="toggleSection('${sectionId}')"]`);section.style.display==="none"||section.classList.contains("hidden")?(section.style.display="block",section.classList.remove("hidden"),chevron.style.transform="rotate(0deg)",button.setAttribute("aria-expanded","true")):(section.style.display="none",section.classList.add("hidden"),chevron.style.transform="rotate(-90deg)",button.setAttribute("aria-expanded","false"))}__name(toggleSection,"toggleSection");jQuery(".edit-btn").on("update-status",function(){jQuery(this).attr("data")==""?jQuery(this).removeClass("active"):jQuery(this).addClass("active")});jQuery("#font-style .btn").on("click",function(){jQuery(this).attr("data")==""?(jQuery(this).addClass("active"),jQuery(this).attr("data",jQuery(this).attr("value"))):(jQuery(this).removeClass("active"),jQuery(this).attr("data","")),jQuery(this).trigger("change-value")});jQuery(".align").on("update-status",function(){jQuery(".align").removeClass("active"),jQuery(this).addClass("active")});window.toggleSection=toggleSection;let canvas,contentRect,contentImage,logo,logoName,logoText,scaleMax,template;if(typeof generatorApplicationURL=="undefined")var generatorApplicationURL="";window.generatorApplicationURL=generatorApplicationURL;function replaceCanvas(){template=jQuery("#canvas-template").find(":selected").attr("value"),canvas&&canvas.dispose();const currentTemplate2=TemplateConstants.getTemplate(template),{width,height,topBorderMultiplier,border}=currentTemplate2;function resizeCanvas(){const wrapperWidth=jQuery(".app-canvas-wrapper").width();jQuery(".canvas-container").css({width:wrapperWidth,height:wrapperWidth*height/width})}__name(resizeCanvas,"resizeCanvas"),jQuery(window).off("resize.canvas").on("resize.canvas",resizeCanvas),canvas=new fabric.Canvas("meme-canvas",{width,height,selection:!0,allowTouchScrolling:!0,backgroundColor:AppConstants.COLORS.BACKGROUND_PRIMARY,preserveObjectStacking:!0,targetFindTolerance:AppConstants.CANVAS.TARGET_FIND_TOLERANCE,perPixelTargetFind:!0}),scaleMax=canvas.width*AppConstants.CANVAS.SCALE_MAX_MULTIPLIER,jQuery("#scale").attr("max",scaleMax);const borderDistance=border>0?canvas.width/border:0,topDistance=borderDistance*topBorderMultiplier;contentRect=new fabric.Rect({top:topDistance,left:borderDistance,width:canvas.width-borderDistance*2,height:canvas.height-(topDistance+borderDistance),fill:AppConstants.COLORS.BACKGROUND_SECONDARY,selectable:!1}),canvas.add(contentRect),resizeCanvas(),CanvasUtils.enableSnap(canvas),CanvasUtils.enableRotationSnap(canvas),CanvasUtils.enablePictureMove(canvas),enableScalingUpdates(),LogoState.isLogoEnabled()&&addLogo(),canvas.renderAll(),window.canvas=canvas,window.contentRect=contentRect,typeof updateCanvasDimensions=="function"&&setTimeout(()=>{updateCanvasDimensions()},50)}__name(replaceCanvas,"replaceCanvas");function calculateLogoTop(logoHeight,template2){if(!canvas||!template2||typeof logoHeight!="number"||logoHeight<=0)return 0;const marginFromBottom=canvas.height*AppConstants.LOGO.BORDERLESS_MARGIN_PERCENT;return canvas.height-marginFromBottom-logoHeight}__name(calculateLogoTop,"calculateLogoTop");function addLogo(){if(!LogoState.isLogoEnabled()){logo!=null&&(canvas.remove(logo),canvas.remove(logoName),logo=null,logoName=null,canvas.renderAll());return}logo!=null&&(canvas.remove(logo),canvas.remove(logoName));const template2=currentTemplate(),scaleTo=template2.logoWidth;logoText=(jQuery("#logo-selection").find(":selected").attr("value")||"").trim().toUpperCase();let logoFilename,textScaleTo,isLongLogo;if(logoText.includes("%")||logoText.length>AppConstants.LOGO.MAX_TEXT_LENGTH){if(logoFilename=AppConstants.LOGO.FILES.LONG,isLongLogo=!0,logoText.includes("%"))logoText=logoText.split("%").map(part=>part.trim()).join(`
